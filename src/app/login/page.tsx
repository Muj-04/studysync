  ...
  return (
    <main className="login-shell">
      ...
      <style>{`
        ...
        .story-copy { margin-top: clamp(28px, 3.8vh, 46px); position: relative; z-index: 3; }
        ...
        .story-copy p { margin: 16px 0 0; max-width: 500px; color: #666b7b; font-size: 14.5px; line-height: 1.65; }
        .login-visual { position: relative; z-index: 2; width: min(100%, 920px); height: clamp(560px, 55vh, 640px); margin: -24px auto 0; }
        .login-students { position: absolute; z-index: 1; top: -54px; left: 50%; width: min(60%, 555px); transform: translateX(-50%); opacity: .88; pointer-events: none; -webkit-mask-image: radial-gradient(ellipse 76% 78% at 50% 54%, #000 65%, transparent 100%); mask-image: radial-gradient(ellipse 76% 78% at 50% 54%, #000 65%, transparent 100%); }
        ...
        .login-product-preview { position: absolute; z-index: 2; right: -8%; bottom: 0; left: -8%; }
        .workspace-preview { overflow: hidden; height: 470px; border: 1px solid rgba(98,74,139,.14); border-radius: 20px; background: rgba(255,255,255,.98); box-shadow: 0 32px 82px rgba(74,50,118,.18), 0 3px 10px rgba(74,50,118,.05); color: #30323f; }
        .workspace-preview-bar { height: 36px; padding: 0 15px; display: flex; align-items: center; gap: 11px; border-bottom: 1px solid #eeeaf4; background: #fff; color: #9a94a4; font-size: 9px; }.workspace-preview-bar > span { flex: 1; text-align: center; }.workspace-preview-bar small { color: #55a876; font-size: 8px; }.workspace-preview-dots { display: flex; gap: 5px; }.workspace-preview-dots i { width: 7px; height: 7px; border-radius: 50%; background: #ffb36b; }.workspace-preview-dots i:nth-child(2) { background: #f3d166; }.workspace-preview-dots i:nth-child(3) { background: #71c894; }
        .workspace-preview-body { height: calc(100% - 36px); display: grid; grid-template-columns: 175px 1fr; }.workspace-preview-body aside { padding: 22px 15px; display: flex; flex-direction: column; gap: 9px; border-right: 1px solid #eeeaf4; background: #fbfafe; font-size: 10px; }.workspace-preview-body aside b, .workspace-preview-body aside span { display: flex; align-items: center; gap: 8px; padding: 9px 10px; border-radius: 7px; }.workspace-preview-body aside b { margin-bottom: 6px; color: #6939d0; }.workspace-preview-body aside span { color: #7d7887; }.workspace-preview-body aside .active { color: #6f3bd8; background: #f0eafd; }
        .workspace-preview-body section { padding: 29px 31px; }.workspace-welcome { display: flex; justify-content: space-between; align-items: center; }.workspace-welcome div { display: flex; flex-direction: column; gap: 5px; }.workspace-welcome small { color: #3b3d48; font-weight: 750; font-size: 13px; }.workspace-welcome strong { color: #96909e; font-size: 9px; font-weight: 500; }.workspace-welcome em { padding: 8px 10px; border-radius: 7px; background: #f3edff; color: #7540df; font-size: 8px; font-style: normal; font-weight: 700; }
        .workspace-actions { display: grid; grid-template-columns: repeat(4,1fr); gap: 9px; margin: 23px 0; }.workspace-actions span { min-width: 0; padding: 13px 8px; display: flex; align-items: center; justify-content: center; gap: 6px; border: 1px solid #e7e1ef; border-radius: 8px; color: #4f4a59; font-size: 8.5px; font-weight: 650; white-space: nowrap; }.workspace-actions svg { color: #7641de; }
        .workspace-content { display: grid; grid-template-columns: minmax(0,1.55fr) minmax(170px,.7fr); gap: 13px; }.recent-study, .workspace-ai { min-width: 0; min-height: 235px; padding: 18px; border: 1px solid #eeeaf4; border-radius: 10px; background: #fff; }.recent-study { display: flex; flex-direction: column; }.recent-study > b { display: block; margin-bottom: 9px; font-size: 10px; }.recent-study p { flex: 1; margin: 0; padding: 11px 0; display: flex; align-items: center; gap: 7px; border-top: 1px solid #f1edf5; color: #5c5865; font-size: 8.5px; }.recent-study p svg { color: #7540df; }.recent-study time { margin-left: auto; color: #a09aa8; }.workspace-ai { display: flex; flex-direction: column; justify-content: center; gap: 10px; color: #716a7d; background: linear-gradient(145deg,#faf8ff,#f2ecff); font-size: 8px; }.workspace-ai > svg { color: #7540df; }.workspace-ai b { color: #4d4658; font-size: 10px; }.workspace-ai span { width: fit-content; padding: 6px 8px; border-radius: 5px; background: #fff; color: #7540df; font-weight: 700; }
        .story-features { position: relative; z-index: 3; display: grid; grid-template-columns: repeat(4, minmax(0,1fr)); gap: 14px; margin-top: 14px; color: #5f586d; }.story-features span { position: relative; display: grid; grid-template-columns: 18px 1fr; align-items: center; column-gap: 6px; }.story-features svg { grid-row: 1 / span 2; align-self: start; color: #7541db; }.story-features b { font-size: 10.5px; }.story-features small { grid-column: 2; margin-top: 2px; color: #7c7685; font-size: 8.5px; line-height: 1.4; }
        ...
        .login-card { position: relative; width: 100%; max-width: 560px; box-sizing: border-box; padding: clamp(48px, 3.7vw, 62px); border: 1px solid rgba(95,71,136,.11); border-radius: 26px; background: rgba(255,255,255,.98); box-shadow: 0 38px 96px rgba(62,43,95,.14), 0 3px 12px rgba(62,43,95,.045); }.login-card::after { content: ''; position: absolute; top: 0; left: 50%; width: 58%; height: 1px; background: linear-gradient(90deg,transparent,rgba(128,75,226,.4),transparent); transform: translateX(-50%); }.mobile-brand { display: none; }
        .login-card h2 { margin: 0; font-size: clamp(36px, 2.25vw, 43px); color: #171a28; letter-spacing: -.042em; }.login-subtitle { margin: 11px 0 42px; color: #777b89; font-size: 14px; }
        ...
        @media (max-width: 1200px) and (min-width: 901px) { .login-shell { grid-template-columns: minmax(510px, 55%) minmax(420px,45%); }.login-story { padding-left: 36px; padding-right: 36px; }.story-copy h1 { font-size: 45px; }.login-visual { height: 475px; margin-top: -18px; }.login-students { top: -38px; width: 62%; }.login-product-preview { right: -5%; left: -5%; }.workspace-preview { height: 370px; }.workspace-preview-bar { height: 31px; }.workspace-preview-body { height: calc(100% - 31px); grid-template-columns: 120px 1fr; }.workspace-preview-body aside { padding: 14px 9px; gap: 5px; font-size: 8px; }.workspace-preview-body aside b, .workspace-preview-body aside span { padding: 6px; }.workspace-preview-body section { padding: 17px; }.workspace-welcome small { font-size: 10px; }.workspace-actions { margin: 15px 0; }.workspace-actions span { padding: 9px 5px; font-size: 7px; }.workspace-content { grid-template-columns: minmax(0,1.5fr) minmax(125px,.7fr); }.recent-study, .workspace-ai { min-height: 125px; padding: 11px; }.recent-study p { padding: 7px 0; }.story-features { gap: 8px; }.story-features small { display: none; }.login-card { padding: 38px; } }
