  ...
  return (
    <main className="login-shell">
      ...
      <style>{`
        ...
        .story-copy { margin-top: clamp(42px, 5.2vh, 64px); position: relative; z-index: 3; }
        .story-copy h1 { margin: 0; max-width: 580px; color: #171a28; font-size: clamp(40px, 2.95vw, 56px); line-height: 1.07; letter-spacing: -.048em; font-weight: 810; }
        ...
        .login-visual { position: relative; z-index: 2; width: min(100%, 920px); height: clamp(480px, 47vh, 555px); margin: 12px auto 0; }
        .login-students { position: absolute; z-index: 1; top: -18px; left: 50%; width: min(61%, 560px); transform: translateX(-50%); opacity: .9; pointer-events: none; -webkit-mask-image: radial-gradient(ellipse 76% 78% at 50% 54%, #000 65%, transparent 100%); mask-image: radial-gradient(ellipse 76% 78% at 50% 54%, #000 65%, transparent 100%); }
        ...
        .workspace-preview { overflow: hidden; height: 325px; border: 1px solid rgba(98,74,139,.14); border-radius: 17px; background: rgba(255,255,255,.98); box-shadow: 0 28px 68px rgba(74,50,118,.15), 0 3px 10px rgba(74,50,118,.05); color: #30323f; }
        ...
        .login-card { position: relative; width: 100%; max-width: 480px; box-sizing: border-box; padding: clamp(38px, 3.2vw, 50px); border: 1px solid rgba(95,71,136,.1); border-radius: 22px; background: rgba(255,255,255,.96); box-shadow: 0 28px 72px rgba(62,43,95,.1), 0 2px 8px rgba(62,43,95,.035); }.mobile-brand { display: none; }
        .login-card h2 { margin: 0; font-size: clamp(33px, 2.05vw, 39px); color: #171a28; letter-spacing: -.042em; }.login-subtitle { margin: 9px 0 38px; color: #777b89; font-size: 14px; }
        ...
        @media (max-width: 1200px) and (min-width: 901px) { .login-shell { grid-template-columns: minmax(510px, 55%) minmax(420px,45%); }.login-story { padding-left: 36px; padding-right: 36px; }.story-copy h1 { font-size: 45px; }.login-visual { height: 420px; }.login-students { width: 66%; }.workspace-preview { height: 280px; }.workspace-preview-body { grid-template-columns: 115px 1fr; }.workspace-preview-body section { padding: 16px; }.story-features { gap: 8px; }.story-features small { display: none; }.login-card { padding: 34px; } }
