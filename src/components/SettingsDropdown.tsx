...
import { Settings, Sun, Moon, X, RotateCcw } from 'lucide-react';
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 8,
        background: active ? 'var(--violet-muted)' : 'var(--bg-elevated)',
        border: `1.5px solid ${active ? 'rgba(139,92,246,0.35)' : 'var(--border)'}`,
